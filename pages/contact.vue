          ...
          <div class="relative mx-auto max-w-prose text-base lg:max-w-none">
            <figure>
              <div class="aspect-w-12 aspect-h-7 lg:aspect-none">
                ...
                <img class="lg:rounded-lg h-32 w-32 rounded-full object-cover object-center shadow-lg"
                     src="~/assets/img/natasha-woodfine.jpg" alt="Natasha Woodfine"/>
              </div>
          ...
          <div class="prose prose-indigo mx-auto mt-5 text-gray-500 lg:col-start-1 lg:row-start-1 lg:max-w-none">
            <form @submit.prevent="sendEmail" method="POST"
              ...
              <div>
                ...
                <div class="mt-1">
                  <input type="text" v-model="contactForm.firstName" name="firstName" id="firstName" autocomplete="given-name"
              ...
              <div>
                ...
                <div class="mt-1">
                  <input type="text" v-model="contactForm.lastName" name="last-name" id="last-name" autocomplete="family-name"
                         class="block w-full rounded-md border-gray-300 shadow-sm focus:border-grape-500 focus:ring-grape-500 sm:text-sm"/>
                </div>
              </div>
              <div class="sm:col-span-2">
                ...
                <div class="mt-1">
                  <input id="email" v-model="contactForm.email" name="email" type="email" autocomplete="email"
                         class="block w-full rounded-md border-gray-300 shadow-sm focus:border-grape-500 focus:ring-grape-500 sm:text-sm"/>
                </div>
              </div>
              ...
              <div class="sm:col-span-2">
                ...
                <div class="mt-1">
                  <textarea id="how-can-we-help" v-model="contactForm.message" name="how-can-we-help"
