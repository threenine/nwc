  ...
  <div>
    <div class="relative bg-yellow-500 ">
      ...
      <div class="relative mx-auto max-w-7xl py-24 px-4 sm:py-32 sm:px-6 lg:px-8">
        ...
        <p class="mt-6 max-w-3xl text-xl text-yellow-100">Version Number: 4.0</p>
        <p class="mt-6 max-w-3xl text-xl text-yellow-100">Last Updated: 1 September 2022</p>
        <p class="mt-6 max-w-5xl text-xl text-yellow-100">This privacy statement explains what personal data Threenine Consulting Limited collects from you and how we use that data.</p>
      </div>
    </div>
    <div class="relative mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:px-0">
      ...
      <div class="pt-12 sm:pt-16 lg:pt-20 max-w-prose">
        <h3 class="text-2xl font-bold tracking-tight text-yellow-500 sm:text-2xl">Your personal Information</h3>
        <div class="mt-6 space-y-6 text-gray-500">
      ...
      <div class="pt-12 sm:pt-16 lg:pt-20 max-w-prose">
        <h3 class="text-2xl font-bold tracking-tight text-yellow-500 sm:text-2xl">Personal data & Information we collect</h3>
        <div class="mt-6 space-y-6 text-gray-500  ">
      ...
      <div class="pt-12 sm:pt-16 lg:pt-20 max-w-prose">
        <h3 class="text-2xl font-bold tracking-tight text-yellow-500 sm:text-2xl">How we collect personal information</h3>
        <div class="mt-6 space-y-6 text-gray-500">
      ...
      <div class="pt-12 sm:pt-16 lg:pt-20 max-w-prose">
        <h3 class="text-2xl font-bold tracking-tight text-yellow-500 sm:text-2xl">The legal basis for collection and use of personal data</h3>
        <div class="mt-6 space-y-6 text-gray-500">
      ...
      <div class="pt-12 sm:pt-16 lg:pt-20 max-w-prose">
        <h3 class="text-2xl font-bold tracking-tight text-yellow-500 sm:text-2xl">Who your personal information will be shared with</h3>
        <div class="mt-6 space-y-6 text-gray-500">
      ...
      <div class="pt-12 sm:pt-16 lg:pt-20 max-w-prose">
        <h3 class="text-2xl font-bold tracking-tight text-yellow-500 sm:text-2xl">Data Export</h3>
        <div class="mt-6 space-y-6 text-gray-500">
      ...
      <div class="pt-12 sm:pt-16 lg:pt-20 max-w-prose">
        <h3 class="text-2xl font-bold tracking-tight text-yellow-500 sm:text-2xl">How long will your personal information be kept for
        </h3>
        <div class="mt-6 space-y-6 text-gray-500">
      ...
      <div class="pt-12 sm:pt-16 lg:pt-20 max-w-prose">
        <h3 class="text-2xl font-bold tracking-tight text-yellow-500 sm:text-2xl">Your right to a copy of your personal information (“subject access request”)</h3>
        <div class="mt-6 space-y-6 text-gray-500">
      ...
      <div class="pt-12 sm:pt-16 lg:pt-20 max-w-prose">
        <h3 class="text-2xl font-bold tracking-tight text-yellow-500 sm:text-2xl">Your right to erasure of your personal information</h3>
        <div class="mt-6 space-y-6 text-gray-500">
      ...
      <div class="pt-12 sm:pt-16 lg:pt-20 max-w-prose">
        <h3 class="text-2xl font-bold tracking-tight text-yellow-500 sm:text-2xl">Your right to restrict processing of your personal information</h3>
        <div class="mt-6 space-y-6 text-gray-500">
      ...
      <div class="pt-12 sm:pt-16 lg:pt-20 max-w-prose">
        <h3 class="text-2xl font-bold tracking-tight text-yellow-500 sm:text-2xl">Your right to object to processing of your personal information</h3>
        <div class="mt-6 space-y-6 text-gray-500">
      ...
      <div class="pt-12 sm:pt-16 lg:pt-20 max-w-prose">
        <h2 class="text-4xl mb-2 font-bold tracking-tight text-yellow-500 sm:text-5xl">Cookies</h2>
        <h3 class="text-2xl font-bold tracking-tight text-yellow-500 sm:text-2xl">Use of cookies</h3>
        <div class="mt-6 space-y-6 text-gray-500">
