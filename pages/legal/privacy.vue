  ...
  <div>
    <div class="relative bg-green-500 ">
      <div class="absolute inset-0">
        ...
        <div class="absolute inset-0 bg-green-500 mix-blend-multiply" aria-hidden="true" />
      </div>
      <div class="relative mx-auto max-w-7xl py-24 px-4 sm:py-32 sm:px-6 lg:px-8">
        ...
        <p class="mt-6 max-w-3xl text-xl text-green-100">Version Number: 4.0</p>
        <p class="mt-6 max-w-3xl text-xl text-green-100">Last Updated: 1 September 2022</p>
        <p class="mt-6 max-w-5xl text-xl text-green-100">This privacy statement explains what personal data Threenine Consulting Limited collects from you and how we use that data.</p>
      </div>
    </div>
    <div class="relative mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:px-0">
      <!-- Content area -->
      <div class="pt-12 sm:pt-16 lg:pt-20 max-w-prose">
        <h2 class="text-4xl font-bold tracking-tight text-green-500 sm:text-5xl">Introduction</h2>
      ...
      <div class="pt-12 sm:pt-16 lg:pt-20 max-w-prose">
        <h3 class="text-2xl font-bold tracking-tight text-green-500 sm:text-2xl">Company Information</h3>
        <div class="mt-6 space-y-6 text-gray-500">
      ...
      <div class="pt-12 sm:pt-16 lg:pt-20 max-w-prose">
        <h3 class="text-2xl font-bold tracking-tight text-green-500 sm:text-2xl">Your personal Information</h3>
        <div class="mt-6 space-y-6 text-gray-500">
          ...
          <p class="prose prose-base leading-7">You are encouraged to review the privacy policy on a regular basis to make sure that you understand how any personal information you provide will be used.</p>

        </div>
      </div>
      <div class="pt-12 sm:pt-16 lg:pt-20 max-w-prose">
        <h3 class="text-2xl font-bold tracking-tight text-green-500 sm:text-2xl">Personal data & Information we collect</h3>
        <div class="mt-6 space-y-6 text-gray-500  ">
          <p class="prose prose-base leading-7"> Personal data, or personal information, means any information about an individual from which that person can be identified. It does not include data where the identity has been removed (anonymous data).
          </p>
          <p class="prose prose-base leading-7">We may collect, use, store and transfer different kinds of personal data about you which we have grouped together in broad classifications as follows:</p>
          <ul role="list" class="list-disc prose prose-base leading-7">
            <li class="mb-2"><b>Identity Data</b> includes first name, maiden name, last name, social media account usernames or similar identifier, date of birth and gender.</li>
            <li class="mb-2"><b>Contact Data</b> includes billing address, delivery address, email address, social media account details and telephone numbers.</li>
            <li class="mb-2"><b>Experience and Education Data</b> includes details of salary expectations, educational and professional qualifications, current and previous employment and work experience (as typically provided in a curriculum vitae).</li>
            <li class="mb-2"><b>Transaction Data </b>includes details of any services we may have provided to you or a customer you may represent as well as details of your involvement in and communication with you in the course of providing those services.</li>
            <li class="mb-2"><b>Marketing and Communications Data </b> includes your preferences in receiving marketing from us and our third parties and your communication preferences.</li>
            <li class="mb-2"><b>Technical Data </b>includes internet protocol (IP) address, your login data, browser type and version, time zone setting and location, browser plug-in types and versions, operating system and platform, and other technology on the devices you use to access our website.</li>
            <li class="mb-2"><b>Usage Data </b> includes information about how you use our website, products and services.</li>
          </ul>
          <p class="prose prose-base leading-7">We may also collect, use and share Aggregated Data such as statistical or demographic data for any purpose. Aggregated Data could be derived from your personal data but is not considered personal data in law as this data will not directly or indirectly reveal your identity. For example, we may aggregate your Usage Data to calculate the percentage of users accessing a specific website feature. However, if we combine or connect Aggregated Data with your personal data so that it can directly or indirectly identify you, we treat the combined data as personal data which will be used in accordance with this privacy policy.</p>
          <p class="prose prose-base leading-7">We do not collect any Special Categories of Personal Data about you (this includes details about your race or ethnicity, religious or philosophical beliefs, sex life, sexual orientation, political opinions, trade union membership, information about your health, and genetic and biometric data). </p>

        </div>
      </div>
      <div class="pt-12 sm:pt-16 lg:pt-20 max-w-prose">
        <h3 class="text-2xl font-bold tracking-tight text-green-500 sm:text-2xl">How we collect personal information</h3>
        <div class="mt-6 space-y-6 text-gray-500">
          <p class="prose prose-base leading-7">We use different methods to collect data from and about you including through:</p>
          <p class="prose prose-base leading-7"><b>Direct interactions. </b> You may give us your Identity and Contact Data by filling in forms or by corresponding with us by post, phone, email or otherwise. This includes personal data you provide when you:</p>
          <ul role="list" class="list-disc prose prose-base leading-7">
            <li class="mb-2">enquire about our products or services;</li>
            <li class="mb-2">interact with us as a client or on behalf of a client (when we will also collect Transaction Data);</li>
            <li class="mb-2">apply for employment or engagement as a contractor or user experience tester with us (when we will also collect Education and Experience Data as well as information about criminal convictions)</li>
            <li class="mb-2">give us feedback or contact us.</li>
            <li class="mb-2">create any account on our website (as applicable);</li>
            <li class="mb-2">subscribe to any of our services or publications;</li>
            <li class="mb-2">request marketing to be sent to you; or</li>
            <li class="mb-2">enter any competition, promotion or survey we may operate.</li>

          </ul>
          <p class="prose prose-base leading-7"><b>Automated technologies or interactions.</b> As you interact with our website, we will automatically collect Technical Data about your equipment, browsing actions and patterns. We collect this personal data by using cookies and other similar technologies. Please see our cookie policy below for further details.</p>
          <p class="prose prose-base leading-7"><b>Third parties or publicly available sources. </b>We may receive personal data about you from various third parties (including public sources), which we may combine with or add to personal information you have directly provided to us, as set out below:</p>
          <ul role="list" class="list-disc prose prose-base leading-7">
            <li class="mb-2">Identity and Contact Data from publicly available sources such as Linked In, Companies House.</li>
            <li class="mb-2">Contact data which we obtain by working with third party technical partners such as Lead Forensics who can provide corporate (but not personal) website visitor information based upon IP Address information, in combination with publicly available sources such as LinkedIn.</li>
            <li class="mb-2">Technical Data from analytics providers such as Google Analytics, who may be based outside the UK;</li>
          </ul>
        </div>
      </div>
      <div class="pt-12 sm:pt-16 lg:pt-20 max-w-prose">
        <h3 class="text-2xl font-bold tracking-tight text-green-500 sm:text-2xl">The legal basis for collection and use of personal data</h3>
        <div class="mt-6 space-y-6 text-gray-500">
          <p class="prose prose-base leading-7">We will only collect and use your personal data when the law allows us to. Most commonly, we will use your personal data in the following circumstances:

          </p>

          <ul role="list" class="list-disc prose prose-base leading-7">
            <li class="mb-2">Where we need to perform the contract we are about to enter into or have entered into with you (or a company you may work for or represent).</li>
            <li class="mb-2">Where we reasonably believe it is in our legitimate interest for the efficient and proper conduct and development of our business and your interests and fundamental rights do not override those interests.</li>
            <li class="mb-2">More specifically, where you are either a client or a representative of a client or where we are marketing our services based upon leads generated through use of third party provided information (which may be based upon use of anonymised website visitor identification in combination with publicly available contact information as set out above), we assert it is in our legitimate interest to send you marketing communications via email or to your social media accounts. All of these communications will include a facility to opt-out from receiving any further communication or your social media platform will provide a facility to block further communications from us.</li>
            <li class="mb-2">Where we need to comply with a legal obligation.</li>
          </ul>
          <p class="prose prose-base leading-7">Generally, we do not rely on consent as a legal basis for processing your personal data except where data protection or privacy law requires this. You will have the right to withdraw any such consent at any time by contacting us.</p>
        </div>
      </div>
      <div class="pt-12 sm:pt-16 lg:pt-20 max-w-prose">
        <h3 class="text-2xl font-bold tracking-tight text-green-500 sm:text-2xl">Who your personal information will be shared with</h3>
        <div class="mt-6 space-y-6 text-gray-500">
          ...
          <p class="prose prose-base leading-7">If you have submitted an application for a vacancy and/or registered your interest in future vacancies, your information will be stored in a separate system, dedicated to the storage of HR information, and will only be made available to the person(s) who require access to it to handle this contact.</p>
          <p class="prose prose-base leading-7">In all cases, personal information is not otherwise sold or shared with any third parties.</p>
        </div>
      </div>
      <div class="pt-12 sm:pt-16 lg:pt-20 max-w-prose">
        <h3 class="text-2xl font-bold tracking-tight text-green-500 sm:text-2xl">Data Export</h3>
        <div class="mt-6 space-y-6 text-gray-500">
      ...
      <div class="pt-12 sm:pt-16 lg:pt-20 max-w-prose">
        <h3 class="text-2xl font-bold tracking-tight text-green-500 sm:text-2xl">How long will your personal information be kept for
        </h3>
        <div class="mt-6 space-y-6 text-gray-500">
          ...
          <p class="prose prose-base leading-7">If you have provided personal information to us as part of our performance of a contract with you or a client that you represent, we will normally keep your personal information (Identity, Contact and Transaction Data) for up to 6 years from completion of the relevant project except where the limitation period in the contract is a longer period of time, in which case we will keep this personal information for that longer period of time. After this time it will be anonymised so as to be no longer personal to you and/or deleted.</p>
          <p class="prose prose-base leading-7">If you have supplied personal information for marketing purposes (through registering for a newsletter for example) and you notify us that you no longer wish to receive these communications, we will only retain the personal information required to ensure that this request is complied with (typically email address).</p>
          <p class="prose prose-base leading-7">If you have supplied your information while checking in at our offices this (and the associated information about when you were there) will be kept for a period of one month before being deleted.</p>
          <p class="prose prose-base leading-7">Personal information supplied as part of a contract signature process will kept in line with the contract retention period, typically seven years from end of service provision.</p>
      ...
      <div class="pt-12 sm:pt-16 lg:pt-20 max-w-prose">
        <h3 class="text-2xl font-bold tracking-tight text-green-500 sm:text-2xl">How you can update your personal information</h3>
        <div class="mt-6 space-y-6 text-gray-500">
      ...
      <div class="pt-12 sm:pt-16 lg:pt-20 max-w-prose">
        <h3 class="text-2xl font-bold tracking-tight text-green-500 sm:text-2xl">Your right to a copy of your personal information (“subject access request”)</h3>
        <div class="mt-6 space-y-6 text-gray-500">
          ...
          <ul role="list" class="list-disc prose prose-base leading-7">
            <li class="mb-2">enquire about our products or services;</li>
            <li class="mb-2">your request not being unfounded or excessive, in which case a charge may apply; and</li>
            <li class="mb-2">the supply of appropriate evidence of your identity (for this purpose, we will usually accept a photocopy of your passport certified by a solicitor or bank plus an original copy of a utility bill showing your current address).</li>

          </ul>
          <p class="prose prose-base leading-7">We may withhold personal information that you request to the extent permitted by law. </p>
        </div>
      </div>
      <div class="pt-12 sm:pt-16 lg:pt-20 max-w-prose">
        <h3 class="text-2xl font-bold tracking-tight text-green-500 sm:text-2xl">Your right to erasure of your personal information</h3>
        <div class="mt-6 space-y-6 text-gray-500">
      ...
      <div class="pt-12 sm:pt-16 lg:pt-20 max-w-prose">
        <h3 class="text-2xl font-bold tracking-tight text-green-500 sm:text-2xl">Your right to restrict processing of your personal information</h3>
        <div class="mt-6 space-y-6 text-gray-500">
      ...
      <div class="pt-12 sm:pt-16 lg:pt-20 max-w-prose">
        <h3 class="text-2xl font-bold tracking-tight text-green-500 sm:text-2xl">Your right to make a complaint</h3>
        <div class="mt-6 space-y-6 text-gray-500">
      ...
      <div class="pt-12 sm:pt-16 lg:pt-20 max-w-prose">
        <h2 class="text-4xl mb-2 font-bold tracking-tight text-green-500 sm:text-5xl">Cookies</h2>
        <h3 class="text-2xl font-bold tracking-tight text-green-500 sm:text-2xl">Use of cookies</h3>
        <div class="mt-6 space-y-6 text-gray-500">
      ...
      <div class="pt-12 sm:pt-16 lg:pt-20 max-w-prose">
        ...
        <h3 class="text-2xl font-bold tracking-tight text-green-500 sm:text-2xl">Opting out of cookies</h3>
        <div class="mt-6 space-y-6 text-gray-500">
      ...
      <div class="pt-12 sm:pt-16 lg:pt-20 max-w-prose mb-5">
        <h3 class="text-2xl font-bold tracking-tight text-green-500 sm:text-2xl">Copyright</h3>
        <div class="mt-6 space-y-6 text-gray-500">
