<template>
  ...
  <div class="relative bg-gray-50 py-24 sm:py-40">
    ...
    <div class="container mx-auto">
      ...
      <h3 class="text-center text-1xl leading-[1.2] tracking-tighter text-slate-900 sm:text-[3.5rem] sm:leading-[4.5rem]">
        Natasha Woodfine </h3>
      <h4 class="text-center text-2xl">Professional Counsellor</h4>
      <div class="space-y-8 text-lg leading-8 mt-16">
        <p class="text-2xl leading-10 tracking-tight text-slate-900">People come to counselling for many reasons from
          anxiety and depression to addiction and from all walks of life. Taking those first steps to making contact and
          undertaking the commitment of counselling can be either difficult or easy, but either way, it can lead to the
          unearthing of your potential, the understanding of your real power and emerging of your purpose and
          meaning</p>
