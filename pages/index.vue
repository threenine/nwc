      ...
      <div class="container mx-auto">
        <div class="relative px-4 sm:px-6 lg:px-8">
          ...
          <div class="mx-auto max-w-prose text-lg">
            <p class="mt-8 text-xl leading-8 text-gray-500">I am a fully qualified counsellor working in the Swindon area,
              offering counselling to adults and young people from age 16 upwards, covering a wide range  of issues.</p>
          </div>
          <div class="prose prose-lg prose-indigo mx-auto mt-6 text-gray-500">
            ...
            <p>Talking about these situations can feel daunting, however reaching out to talk could be what it takes to stop suppressing these concerns, which can help your well-being.</p>
            <span class="text-2xl font-bold">How can we work together</span>
            <p>My approach to counselling is a person-centred one. I feel the relationship between client and counsellor is fundamental in helping to provide the supportive environment where you can have the opportunity to gain a better understanding of yourself and the challenges you are facing. Here you will be able to explore what is concerning you, without judgement, keeping at your pace where I will truly hear you as you present your thoughts and feelings. I am led by you the client, and believe that given the right environment you hold the answers to your own freedom and growth. I will listen and we can explore what is going on for you and reflect back the impact this has had on you.  </p>
