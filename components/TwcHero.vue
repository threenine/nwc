      ...
      <div class="w-full lg:w-2/3">
        <div class="lg:max-w-lg">
          ...
          <div class="mt-8 space-y-5">
            <p v-for="item in benefits" class="flex items-center -mx-2 text-gray-100">
              <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 mx-2 text-green-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>

              <span class="mx-2 font-medium">{{ item.benefit }}</span>
            </p>
        ...
        <div class="w-full mt-8 bg-transparent border rounded-md lg:max-w-sm border-yellow-100 focus-within:border-yellow-400 focus-within:ring focus-within:ring-yellow-300 dark:focus-within:border-yellow-400 focus-within:ring-opacity-40">
          <form class="flex flex-col lg:flex-row">
            ...
            <button type="button" class="h-10 px-4 py-2 m-1 text-white transition-colors duration-200 transform bg-yellow-500 rounded-md hover:bg-yellow-100 hover:text-yellow-900 focus:outline-none focus:bg-yellow-400">
              Start
            </button>
          </form>
        </div>
